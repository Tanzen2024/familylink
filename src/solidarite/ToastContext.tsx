        ...
        {toasts.map((t) => {
          ...
          return (
            <div key={t.id} className="sol-toast">
              <div className="sol-toast-icon" style={{ background: bg, color }}>
                <Icon size={18} />
              </div>
              <div style={{ flex: 1 }}>
              ...
              <button onClick={() => dismiss(t.id)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--color-neutral-400)' }}>
                <X size={16} />
              </button>
            </div>
          )
